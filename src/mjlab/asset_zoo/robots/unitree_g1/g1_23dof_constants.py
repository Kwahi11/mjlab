...
G1_23DOF_ASSETS_DIR = G1_23DOF_XML.parent / "assets"
assert G1_23DOF_ASSETS_DIR.exists()


def get_assets() -> dict[str, bytes]:
  """Load mesh assets referenced by the G1 23DoF MJCF."""
  assets: dict[str, bytes] = {}
  for path in G1_23DOF_ASSETS_DIR.iterdir():
    if path.is_file():
